...
fase_t* seleccionar_dificultad() {
    ...
    menu_agregar_comando(menu_dificultades, "H", "Se imprime ayuda del menu.", mostrar_comando_y_descripcion);
...
fase_t* armado_de_atributos_oponente() {
    ...
    menu_agregar_comando(menu_oponente, "C", "Continuar el juego", pasar_a_seleccionar_pokemon);
    menu_agregar_comando(menu_oponente, "H", "Se imprime ayuda del menu.", mostrar_comando_y_descripcion);
...
fase_t* inicializar_pokemon_usuario(estado_t* estado) {
    ...
    menu_agregar_comando(menu_usuario, "C", "Continuar el juego", pasar_a_armar_pista);
    menu_agregar_comando(menu_usuario, "H", "Se imprime ayuda del menu.", mostrar_comando_y_descripcion);


    fase_usuario->contenido = mostrar_info_pokemon_usuario;


    liberar_memoria_split(pokemones_disponibles, tp_cantidad_pokemon(estado->juego));
...
fase_t* armar_pista_del_usuario() {
    ...
    menu_agregar_comando(menu_pista_usuario, "C", "Continuar el juego", pasar_a_correr_carrera);
    menu_agregar_comando(menu_pista_usuario, "H", "Se imprime ayuda del menu.", mostrar_comando_y_descripcion);
...
fase_t* correr_carrera() {
    ...
    menu_agregar_comando(menu_carrera, "F", "Continuar el juego", pasar_a_fin_juego);
    menu_agregar_comando(menu_carrera, "A", "Volver a modificar la pista", volver_a_modificar_pista);
    menu_agregar_comando(menu_carrera, "H", "Se imprime ayuda del menu.", mostrar_comando_y_descripcion);
